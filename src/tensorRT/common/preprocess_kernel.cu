...
namespace CUDAKernel{
	...
	*/
	...
	static	__global__ void gpuConvertYUYVtoRGB_kernel(const uint8_t *src, uint8_t *dst,
	...
	void gpuConvertYUYVtoRGB(
		...
		checkCudaKernel(gpuConvertYUYVtoRGB_kernel<<<numBlocks, blockSize, 0, stream>>>(
